...
export default function FakeCalendar() {
  return (
    <Box width={"100%"} shadow={"dark-lg"} padding={5} position="relative">
      <VStack width={"100%"}>
        <Box backgroundColor={"orange.400"} width={"100%"}>
          <Text textColor={"black"} fontSize={"3xl"}>
            Planned Outages/Maintenance (EST-PST)
          </Text>
        </Box>
        <HStack justify={"center"}>
          ...
          <Spacer />
          <Link fontSize={"2xl"} textColor={"black"}>
            November 2022
          </Link>
          <Spacer />
          <Link>
